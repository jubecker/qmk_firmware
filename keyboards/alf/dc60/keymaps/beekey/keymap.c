...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		KC_LSFT, KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_MUTE,
		KC_LCTL, MO(2), KC_LALT, KC_LGUI, LT_LOWER, LT_LOWER, KC_RALT, KC_RGUI, KC_RGUI, MO(2), KC_RCTL),
