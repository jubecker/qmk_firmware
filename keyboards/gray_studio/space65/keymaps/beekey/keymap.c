...
[2] = LAYOUT( \
        ...
        _______, RGB_HUD,  RGB_HUI, RGB_VAD, RGB_VAD, _______, BL_TOGG, BL_DEC, 	BL_INC,  BL_STEP, _______, _______, _______, _______,     _______, \
        _______, RGB_RMOD, RGB_MOD, RGB_TOG, _______, _______, _______, _______, _______, _______, _______, _______, _______,               _______, \
        _______, _______, RGB_SAD,  RGB_SAI, _______, _______, _______, _______, _______, _______, _______, _______, _______,      _______, _______, \
