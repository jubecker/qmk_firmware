 ...
 * | Shift |   Z   |   X   |   C   |   V   |   B   ||   N   |   M   |   ,   |   .   |   /   |   "   |
 * |-------+-------+-------+-------+-------+-------++-------+-------+-------+-------+-------+-------|
 * | Ctrl  | Raise | Adjust|  Alt  | Gui   | LW_SPC|| RS_SPC| Adjust| Left  | Down  |  Up   | Right |
 * `------------------------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT( \
    ...
    KC_LCTL,RAISE,  ADJUST, KC_LALT,KC_LGUI,LT_LOWR, LT_RAIS,ADJUST, KC_LEFT,KC_DOWN,KC_UP,  KC_RIGHT \
),
 ...
 * |   ~   |       | Vol+  |   €   |       |       ||       | PgDn  | Up    | PgUp  |   -   |   =   |
 * |-------+-------+-------+-------+-------+-------++-------+-------+-------+-------+-------+-------|
 * |       | Stop  | Mute  | Play  |       |       || Home  | Left  | Down  | Right |   [   |   ]   |
 * |-------+-------+-------+-------+-------+-------++-------+-------+-------+-------+-------+-------|
 * |       |       | Vol-  |       |       |       ||   ~   |       |       |       |   \   |   |   |
 * |-------+-------+-------+-------+-------+-------++-------+-------+-------+-------+-------+-------|
 * |       |       |       |       |       |       ||       |       |       |       |       |       |
...
[_LOWER] = LAYOUT(
    KC_GRV,_______,KC_VOLU,KC_EURO,_______,_______, _______,KC_PGDN,KC_UP,  KC_PGUP, KC_MINS,KC_EQL,  \
    _______,KC_MSTP,KC_MUTE,KC_MPLY,_______,_______, KC_HOME,KC_LEFT,KC_DOWN,KC_RGHT,KC_LBRC,KC_RBRC, \
...
[_ADJUST] =  LAYOUT( \
    ...
    _______,KC_F11, KC_F12, _______,_______,_______,_______,_______,_______,_______,_______,KC_SLEP, \
